...
export const HeroText = () => {
    ...
    return (
        <div>
            ...
            {
                (currentUser.user_role == 4) ? <Button ButtonName="Course Tracker" ButtonStyle="button primary-button" ButtonSrc="/course-tracker"/> : ""
            }
            {
                (currentUser.permissions !== undefined && currentUser.permissions.user_permission_id == 1) ? <Button ButtonName="Course Tracker" ButtonStyle="button primary-button" ButtonSrc="/course-tracker"/> : ""
            }
